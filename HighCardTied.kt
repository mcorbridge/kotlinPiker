...
class HighCardTied {
    ...
    companion object{
        ...
        fun makeHands(){
            ...
            var card0 = Card("diamond", "ace", 14)
            hand0.cards.add(card0)
            var card1 = Card("club", "12", 12)
            hand0.cards.add(card1)
            var card2 = Card("heart", "4", 4)
            hand0.cards.add(card2)
            var card3 = Card("diamond", "2", 2)
            ...
            var card40 = Card("diamond", "king", 13)
