...
class PairTied {
    ...
    companion object{
        ...
        fun makeHands(){
            ...
            var card0 = Card("diamond", "7", 7) //<--- tied pair
            hand0.cards.add(card0)
            var card1 = Card("club", "7", 7) //<--- tied pair
            hand0.cards.add(card1)
            var card2 = Card("heart", "8", 8)
            hand0.cards.add(card2)
            var card3 = Card("diamond", "9", 9)
            hand0.cards.add(card3)
            var card4 = Card("club", "6", 6)
            hand0.cards.add(card4)


            var card10 = Card("heart", "7", 7) //<--- tied pair
            hand1.cards.add(card10)
            var card11 = Card("spade", "7", 7) //<--- tied pair
            hand1.cards.add(card11)
            var card12 = Card("club", "8", 8)
            hand1.cards.add(card12)
            var card13 = Card("heart", "9", 9)
            hand1.cards.add(card13)
            var card14 = Card("diamond", "6", 6)
            ...
            var card23 = Card("heart", "10", 10) // <- high card
