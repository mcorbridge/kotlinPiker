...
class TwoPairTied {
    ...
    companion object{
        ...
        fun makeHands(){
            ...
            var card1 = Card("heart", "4", 4)
            hand0.cards.add(card1)
            var card2 = Card("club", "6", 6)
            hand0.cards.add(card2)
            var card3 = Card("diamond", "6", 6)
            hand0.cards.add(card3)
            var card4 = Card("spade", "jack", 11)
            hand0.cards.add(card4)


            var card10 = Card("club", "4", 4)
            hand1.cards.add(card10)
            var card11 = Card("diamond", "4", 4)
            hand1.cards.add(card11)
            var card12 = Card("diamond", "6", 6)
            hand1.cards.add(card12)
            var card13 = Card("heart", "6", 6)
            hand1.cards.add(card13)
            var card14 = Card("club", "jack", 11)
            hand1.cards.add(card14)


            var card20 = Card("heart", "2", 2)
            hand2.cards.add(card20)
            var card21 = Card("club", "3", 3)
            hand2.cards.add(card21)
            var card22 = Card("diamond", "4", 4)
            hand2.cards.add(card22)
            var card23 = Card("spade", "5", 5)
            hand2.cards.add(card23)
            var card24 = Card("heart", "7", 7)
            hand2.cards.add(card24)


            var card30 = Card("club", "5", 5)
            hand3.cards.add(card30)
            var card31 = Card("diamond", "6", 6)
            hand3.cards.add(card31)
            var card32 = Card("heart", "7", 7)
            hand3.cards.add(card32)
            var card33 = Card("spade", "8", 8)
            hand3.cards.add(card33)
            var card34 = Card("club", "2", 2)
            hand3.cards.add(card34)


            var card40 = Card("spade", "ace", 14)
            hand4.cards.add(card40)
            var card41 = Card("heart", "3", 3)
            hand4.cards.add(card41)
            var card42 = Card("spade", "3", 3)
            hand4.cards.add(card42)
            var card43 = Card("club", "8", 8)
            hand4.cards.add(card43)
            var card44 = Card("diamond", "king", 13)
